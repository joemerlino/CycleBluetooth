#include "CBTRootListController.h"

@implementation CBTRootListController
	...
	-(void) sendEmail{
		[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"mailto:merlino.giuseppe1@gmail.com?subject=CycleBluetooth"]];
	}
@end
